package br.com.yansabarense.todolist.task;

import br.com.yansabarense.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        if(currentDate.isAfter(taskModel.getStartAt().atStartOfDay()) || currentDate.isAfter(taskModel.getEndAt().atStartOfDay())){
